...
const content = {
  ...
  html: (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10vh', width: '98%' }}>
      ...
      <Typography>
        As I am keen on having a scalable and mechanically flexible website, it is really important
        to create a sustainable folder system as the content is going to keep on expanding over
        time.
      </Typography>
      ...
      <Typography>
        ...
        <strong>Home</strong>, <strong>Archives</strong> and <strong>Portfolio</strong>. There is a
        very important component here, <strong>ContentPage</strong>, which is the generic component
        which hosts any content, either from the Archives or the Portfolio and although it has some
      ...
      <Typography>
        ...
        across your front-end. More specifically, in terms of MUI, it will allow for any subsequent
        components you use from it to automatically adapt to the styling requirements of the current
        mode you are using.
      </Typography>
      ...
      <Typography>
        ...
        <strong style={{ color: Colors.idleYellow }}>react-router-dom</strong> to create some basic
        navigation for the website. This allowed me to split my work for this website into chunks
        according to each screen I had to individually work with.
      </Typography>

      <Typography>
        Below you can find the color palette that I oftenly use for my applications, including this
        website. You can copy individual colors to the clipboard by clicking on them or the entire
        array by clicking on the <strong>Copy Palette</strong> button.
      </Typography>
      ...
      <Typography>
        ...
        automatically generating content based on the route in which it exists. For example, in your
        current url, you will see the route:
      </Typography>
      ...
      <Typography>
        ...
        ) and your Vercel project settings, in order to properly set up your DNS certificates. Here
        is a quick quide on how to do it (and a generally useful link to{' '}
        <strong
          style={{
            cursor: 'pointer',
            textDecoration: 'underline',
